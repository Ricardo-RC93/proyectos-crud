const PiePagina = () => {
  return (
    <footer className="bg-linear-to-r from-emerald-900 via-green-900 to-teal-900 text-white mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-xl font-bold bg-linear-to-r from-emerald-400 to-green-400 bg-clip-text text-transparent">
                Biblioteca Virtual
              </h3>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed">
              Tu plataforma de gestión literaria. Administra, organiza y
          ...
          {/* Columna 3: Géneros Literarios */}
          <div>
            <h3 className="text-xl font-bold mb-3">Géneros</h3>
        ...
        <div className="border-t border-white/10 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm flex items-center gap-2">
              📖 © 2025 Biblioteca Virtual. Cultivando el amor por la lectura.
            </p>
